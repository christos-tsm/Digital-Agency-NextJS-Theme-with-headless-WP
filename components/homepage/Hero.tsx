...
const Hero = ({ content }: HeroSectionInterface) => {
    ...
    const handleVideoPopup = (e: React.MouseEvent<HTMLAnchorElement | HTMLDivElement>) => {
    ...
    return (
        <>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex lg:items-center xl:items-end gap-5 lg:gap-10 flex-col lg:flex-row">
                            <div className="relative inline-flex lg:min-w-[370px] max-w-[370px] overflow-hidden rounded-xl">
                                ...
                                <a href="#!" onClick={handleVideoPopup} aria-label="Play video button" className="w-12 h-12 bg-primary text-white absolute top-1/2 left-1/2 -translate-1/2 rounded-full inline-flex items-center justify-center z-2">
                                    <Play />
                                </a>
                            </div>
            ...
            <div onClick={handleVideoPopup} className={`fixed top-0 left-0 w-full h-full bg-black/80 z-50 flex items-center justify-center transition-opacity duration-500 ${isVideoPopupOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
                <div onClick={(e) => e.stopPropagation()}>
                    <video ref={videoRef} width="500" height="500" controls className="w-full h-auto">
